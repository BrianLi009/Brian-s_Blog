...
To measure the probaility that there exists $\frac{n-1}{2}$ "0"s, we will use combination to express the total number of ways for that to happen: $\mathbf{Inf}_i[f]=2 \cdot \left[\left(\frac{1}{2}\right) \cdot \frac{n\choose{\frac{n-1}{2}}}{2^{n-1}}\right]$
